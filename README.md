...
Because kinematic equations depends on the previous timestep, with the latency, acutation would be used in next another timestep. To deal with it, One approach is changed as follows:
```
 if (t > 1) {
   a = vars[a_start + t - 2];
...
* **Ipopt and CppAD:** Please refer to [this document](https://github.com/udacity/CarND-MPC-Project/blob/master/install_Ipopt_CppAD.md) for installation instructions. 
  ...
  (Hint: New solution for installation problem in linux has been added in document personally)
